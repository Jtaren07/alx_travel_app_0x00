...
import random
drom datetime import datetime, timedelta
...
class Command(BaseCommand):
    help = "Seeds the datebase with sample listings, bookings, and reviews"

    def handle(self, *args, **options):
        self.stdout.write("Deleting existing sata...")
